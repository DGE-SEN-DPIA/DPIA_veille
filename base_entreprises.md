...
- À surveiller : Closing Série D ~$3,5 Md / $23 Md (investisseurs + date) ; release publique MoE open-weight (été 2026) ; ouverture Les Ulis Q3 2026 ; confirmation chiffre GPU Bruyères-le-Châtel (discordance 13 800 vs. 18 000) ; extension de L'Assistant aux collectivités territoriales ; résultats commerciaux Industrial Engineering ; financement Suède ; premiers déploiements Robostral Navigate en flotte industrielle ; adoption Leanstral 1.5 pour audit de code IA dans les secteurs réglementés ; déploiements effectifs air-gap Azure Local.
...
- À surveiller : Release officielle Astra/GPT-6 (date inconnue) ; rapport technique OpenAI à HF (toujours attendu) ; premiers clients Presence hors BBVA/SoftBank/IAG ; Annonce officielle IPO (Kalshi : mars 2027 à 59 %) ; implantations européennes additionnelles.
...
- Produits / modèles : Gemini 2.x (frontière), Gemma (open-weights), AlphaCode, AlphaFold, D4RT (Best Paper CVPR 2026, reconstruction dynamique 4D 18-300× plus rapide que l'état de l'art).
  **Gemini 3.5 Pro** — annoncé à Google I/O 2026 (19/05). GA reportée **7 fois consécutives** : juin, mi-juillet, 17/07, 21/07, semaine 28/07, 31/07, 7/08/2026. Fuite non confirmée Google : lancement le 12/08 [NPowerUser, 1 source]. Modèle toujours en preview limitée Vertex AI au 10/08.
