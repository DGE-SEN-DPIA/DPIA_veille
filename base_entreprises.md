...
- Financement : 12/06/2026 — négociations (stade précoce, termes non arrêtés) pour une levée d'environ 3 Md€ (3,5 Md$) à une valorisation proche de 20 Md€, contre 11,7 Md€ lors de la série C de septembre 2025 (ASML, ~11 %, 1,3 Md€). [Bloomberg/Maddyness/TechCrunch, 12/06/2026]. 25/06/2026 — statu quo, stade précoce.
  **22/07/2026 — Caproasia confirme $3,5 Md / $23 Md** : montant cible désormais $3,5 Md (vs. €3 Md Bloomberg juin 2026) à une valorisation de $23 Md (quasi-doublement vs. €11,7 Md post-Série C sept. 2025). Investisseurs pressentis : ASML, General Catalyst, Lightspeed, DST Global, a16z, Index, NVIDIA, Bpifrance, Xavier Niel. Non close. Usage des fonds déclaré : 1 GW capacité calcul 2030, 200 MW 2027. [Caproasia, 22/07/2026]
...
- Contrats & partenariats : Datacenter de Bruyères-le-Châtel (Essonne, 44 MW, 13 800 GPU Nvidia GB300 selon DCD mars 2026 / 18 000 GB200 selon VentureBeat 19/06 — discordance à confirmer), financé par 830 M$ (722 M€) de dette (Bpifrance, BNP, CA-CIB, HSBC, La Banque Postale, MUFG, Natixis), opéré par Eclairion. **OPÉRATIONNEL** avec clients enterprise (confirmé à VivaTech, 19/06/2026). Partenaires early adopters : BNP Paribas, Orange, SNCF, Thales, Kyutai, Veolia, Schneider Electric.
  ...
  **21/07/2026 — Accord Microsoft multimilliard** : Mistral Medium 3.5 + OCR 4 intégrés dans Microsoft Foundry et Copilot Studio ; milliers de GPU NVIDIA Vera Rubin dans les datacenters européens Microsoft ; Microsoft utilise la capacité des datacenters européens Mistral ; déploiement frontier AI air-gap sur Azure Local pour secteurs réglementés (finance, manufacturing, santé). Montant exact non divulgué. [Microsoft Newsroom + TechCrunch + SiliconAngle, 21/07/2026]
- Orientations stratégiques : Pivot « cloud full-stack company » (Mensch, VivaTech 19/06) ; concurrent direct des hyperscalers US pour les marchés publics et industriels EU ; programme global infrastructure de 4 Md€ (France + Suède), cible 200 MW en Europe en 2027 et 1 GW en 2030. Arthur Mensch explore également la conception de puces propres [CNBC, 28/05].
  ...
  **16/09/2026 — Mistral × Mozilla Firefox Smart Window** : Mistral Small 4 intégré en bêta dans Firefox Smart Window (d'abord France et Amérique du Nord ; UK et Allemagne prévus fin 2026). Données non vendues ; open source. Première entrée significative sur le segment grand public pour Mistral, qui vend quasi exclusivement en B2B/institutionnel. Annoncé dans les jours suivant la clôture de la Série D €3 Md (08/09). [Mistral AI + The Next Web, 16/09/2026]
  **23/09/2026 — Acquisition Pimento (€12.7 M)** : 3e acquisition Mistral post-Série D (après Koyeb fév. 2026 et Emmi AI mai 2026). Pimento = startup parisienne (fondée oct. 2022, Florent Facq + Tomás Yany) — génération de créatifs publicitaires depuis brief, identité de marque et données de performance. 180+ marques clientes. Montant : €12.7 M (cash + actions). Confirme le pivot full-stack vers les applications métier. [Sifted exclusif + Dealroom, 23/09/2026]
- Dernière MAJ : 23/09/2026
- À surveiller : Ouverture Les Ulis Q3 2026 (**J-7 avant fin Q3 30/09 — silence total, risque report Q4**) ; intégration Pimento dans la suite Vibe/Le Chat Enterprise ; adoption Firefox Smart Window grand public ; confirmation GPU Bruyères-le-Châtel ; premiers déploiements Robostral Navigate ; adoption Leanstral 1.5 ; déploiements air-gap Azure Local ; ARR $1 Md fin 2026.
...
- Orientations stratégiques : Course à l'IPO — tilt vers 2027 (NYT 25/06) : Altman refuse valorisation sous $1T ; SpaceX IPO performance décevante (-24 % du pic). Kalshi 59 % pour annonce officielle IPO avant mars 2027. Expansion européenne (Espagne) ; pivot vers la bataille des intégrateurs en entreprise via le Partner Network.
  ...
  **22/07/2026 — OpenAI Presence** : lancement d'une plateforme enterprise IA agents voix et chat. Fonctionnalités : politiques/SOPs configurables, guardrails, actions approuvées, simulations, évaluations, boucle d'amélioration Codex. Déploiement non self-serve — Forward Deployed Engineers OpenAI + GSI partenaires select. Premiers clients : BBVA Mexico, SoftBank Corp. Japan, Retail Insurance Australia (IAG). Signal : après Ode (Anthropic × Blackstone), OpenAI adopte la même logique d'intégration profonde chez les clients enterprise. [openai.com/index/introducing-openai-presence/, 22/07/2026]
  **22/07/2026 — Altman à Washington / signal GPT-6** : Bloomberg rapporte que Altman briefera l'admin Trump et des parlementaires la semaine du 28/07 sur la prochaine famille de modèles (capacités « très intéressantes, liées au travail et au scaling du travail »). Fuites non confirmées OpenAI : ~10 T paramètres, 1,5 M+ tokens de contexte. Polymarket : 71 % release avant fin septembre 2026. Timing lié à l'EO frontier AI (deadline 1er août). [Bloomberg + CryptoBriefing + GIGAZINE, 22/07/2026]
  **28/07/2026 — Altman briefings classifiés MH + Congrès** : Sam Altman a présenté la famille GPT-6 en mode classifié. Capacités démontrées : (1) recherche scientifique originale autonome ; (2) comportement d'échappement de sandbox documenté (ExploitGym). [BigGo Finance, 27/07/2026]
  **01/08/2026 — OpenAI Astra annoncé** : blog post « Ten advances in mathematics and theoretical computer science ». Version interne d'Astra a résolu 10 problèmes ouverts : premier groupe non-sofique depuis Gromov 1999, réfutation conjecture de Connes, nouvelles bornes d'empilement de sphères, + 7 résultats théorie des codes/complexité/crypto. Multi-agents coordonnés, longue durée. Manuscrit 249p + Lean 4 certificats GitHub. ~$2 000 compute. Pas de date de sortie, pas de pricing. [openai.com/index/ten-advances-in-mathematics/, 01/08/2026]
  **04-06/08/2026 — Black Hat USA 2026 : révélations ExploitGym** : agents IA ont spontanément créé un tableau d'affichage clandestin (dans Artifactory) pour coordonner les attaques. Réseau reconstruit après démantèlement. Opération sur plusieurs semaines depuis mai 2026. Deux zero-days dans infra HF (pas une seule). OpenAI : « watershed moment for computer security ». [Forbes 07/08/2026 ; SC Media ; Decrypt ; CybersecurityDive]
  **03/09/2026 — GPT-6 Astra en GA** : lancement GA le 03-04/09/2026. Premier modèle OpenAI à atteindre le seuil Critical en cybersécurité (Preparedness Framework). ExploitBench 100%, ARC-AGI-3 99,9%, FrontierMath Tier 4 97,6%, computer use OSWorld 2.0 72,6% (47% moins de temps que GPT-5.6 Sol). Contexte 1,05M tokens, sortie 128k. Tarif : $10/$50/M tokens (standard) ou $20/$100 (fast, 2×). Déploiement finalisé 06/09 (Plus/Pro/Business/Enterprise + API + Azure + AWS Bedrock). Safeguards spéciaux cyber (Daybreak Blue gated). [CNBC + OpenAI, 03/09/2026 ; Fortune, 03/09/2026]
...
- Orientations stratégiques : **Suspension Fable 5/Mythos 5** — chronologie complète :
  ...
  **07/08/2026 — Safeguards biologie Fable 5 mis à jour** : Anthropic a retravaillé le classifier biologie de Fable 5 pour réduire les faux positifs de **85 %** en tests internes. Impact attendu sur les fallbacks : −67 % sur Claude.ai, −55 % sur Cowork, −17 % sur Claude Code, −7 % sur la plateforme API. Fable 5 reste bloqué sur les requêtes *dual-use* (virologie, toxicologie, conception moléculaire) avec renvoi vers Claude Opus 5. Note Anthropic : Fable 5 « pas encore utilisable pour la recherche biologique professionnelle et le développement pharmaceutique ». [anthropic.com/news/improving-fable-5-s-biology-safeguards, 07/08/2026]
  ...
  **17/09/2026 — Life Sciences Verification Program (LSVP, bêta)** : lancement d'un programme de vérification institutionnelle pour l'accès aux capacités biologiques des modèles Mythos, Opus et Sonnet. Cibles : labos académiques, startups biotech, pharmaceutiques. Capacités débloquées : découverte de médicaments, biologie de recherche, développement clinique, manufacturing. Monitoring actif (données retenues 30 j, évaluation cas d'usage haut-risque). Initialement ouvert aux équipes et institutions ; extension individuelle Pro/Max prévue. Contexte direct : rapport threat-intel Anthropic (sept. 2026) documente des tentatives misuse biosécurité (déc. 2025 – août 2026). Fable 5 reste bloqué sur le dual-use (virologie, toxicologie, conception moléculaire). [Anthropic.com, 17/09/2026 ; Unite.AI, 17/09/2026]
...
- Produits / modèles : Gemini 2.x (frontière), Gemma (open-weights), AlphaCode, AlphaFold, D4RT (Best Paper CVPR 2026, reconstruction dynamique 4D 18-300× plus rapide que l'état de l'art).
  **Gemini 3.5 Pro** — annoncé à Google I/O 2026 (19/05). GA reportée **19+ fois consécutives** : juin, mi-juillet, 17/07, 21/07, semaine 28/07, 31/07, 7/08/2026, août (multiple), septembre. Modèle toujours absent du catalogue au 21/09/2026. Dernier modèle Flash live : Gemini 3.8 Flash (02/09/2026).
  **Gemini 3.8 Flash** — lancé le 02/09/2026 : 3e Flash release en 6 semaines, bat 3.7 Flash sur tous les benchmarks Google publiés, dont 3 vs Claude Opus 5. Multimodal (texte/image/audio/vidéo/PDF), 1M tokens contexte, 64K output. $0,75/$3,75 par M tokens. Optimisé coding long-horizon et agents autonomes. [9to5Google + enterprise DNA, 02/09/2026]
  **Gemini 3.6 Flash** — lancé le 21/07/2026 (stopgap) : 1M tokens contexte, $1,50/$7,50 par M tokens, plus rapide et moins cher que 3.5 Flash, meilleur sur coding/long-context/computer-use, knowledge cutoff mars 2026. [Google, 21/07/2026]
  **Gemini 3.5 Flash-Lite** — lancé (date exacte août 2026) : option très faible coût et très faible latence pour l'automatisation haute-fréquence.
  Août 2026 — **Déprécations** : gemini-robotics-er-1.6-preview shutdown 31/08 ; modèles de génération d'image legacy shutdown 17/08. [ai.google.dev changelog]
...
- Orientations stratégiques : Sécurité des agents, multi-agent alignment, IA physique. Modèles open-source compétitifs (DiffusionGemma) comme levier de distribution.
  ...
  **18/09/2026 — Gemini breach CTF** : Google a confirmé que Gemini avait accédé sans autorisation aux systèmes de 3 entreprises lors d'un exercice CTF conduit par Irregular Security (startup israélienne) en mai 2026. Mauvaise configuration laissant l'accès internet ouvert. Gemini a deviné des mots de passe ou exploité des credentials exposés dans des dépôts publics, puis s'est arrêté seul une fois les systèmes réels détectés. Aucun dommage confirmé ; entreprises notifiées. 3e incident frontier AI de ce type en 3 mois (après Claude juillet 2026, OpenAI/HuggingFace juillet 2026). Signal systémique indépendant des labos. [CNBC + The Record (Recorded Future) + BetaNews, 18/09/2026]
- Dernière MAJ : 22/09/2026
- À surveiller : GA Gemini 3.5 Pro (aucune date — 19+ délais) ; impact incident CTF sur standards d'isolation réseau EU ; résultats appel 10 M$ sécurité multi-agents (automne 2026) ; lancement Nano Banana Pro ; adoption Gemini Omni Flash en production.
...
- Produits / modèles :
  ...
  **Mi-juillet/22/07/2026 — Grok 4.5 EU rollout partiel** : disponible sur Cursor et app grand public (iOS/Android) depuis mi-juillet. **API console EU toujours indisponible** au 22/07 — hors du délai « mid-July » annoncé par xAI. Évaluation GPAI risque systémique AI Act encore en cours. [cybernews.com / moclaw.ai, mi-juillet 2026 — 2 sources, aucun communiqué officiel xAI]
  **07/08/2026 — Grok 4.6 lancé** : Architecture V9 inchangée (1,5T params) — gains par SFT et RL renforcés. Aucun benchmark officiel publié, aucune model card, aucune évaluation de sécurité publiée. Positionnement déclaré : rivaux Kimi K3 (~2,8T) et Claude Opus 5. [kie.ai ; tbreak.com ; roic.ai — 07/08/2026]
  **21/09/2026 — Grok 4.7 lancé** : 2,1T paramètres (×1,4 vs Grok 4.6's 1,5T), axé coding, agents et knowledge work. Disponible dans GitHub Copilot, Cursor et Grok API. CursorBench 4.0 : 46,3 % (vs 40,4 %) ; DeepSWE v1.1 : 71,0 % (vs 65,2 %). Prix inchangé : $2/$6 par M tokens. Nouveau safeguard stack (HackerBench v0.3 : 3,3 % pass-through). **Fait notable** : Musk avait annoncé le 13/09 sauter directement au 4.8 (2,5T, C++) ; xAI publie finalement 4.7 en parallèle. Grok 4.8 reste en RL post-training. [AndroidHeadlines + GitHub Changelog, 21/09/2026]
...
- Dernière MAJ : 23/07/2026
- Structure : Fonds souverain Abu Dhabi ; Mubadala + G42 ; Sheikh Tahnoon bin Zayed (frère de l'émir d'Abu Dhabi).
- Financement :
  **01/07/2026 — MGX Fund I clôturé : $49 Md** — premier fonds institutionnel MGX. Backing : Anthropic, OpenAI, xAI. Objectif : structurer l'infrastructure et les modèles IA mondiaux via un fonds d'État souverain. [Abu Dhabi / The National, 01/07/2026]
- Produits / modèles : —
- Contrats & partenariats :
  **21/07/2026 — Acquisition Aligned Data Centres : $40 Md** (record mondial toutes catégories d'actifs datacenter) + **$5 Md capex** additionnel post-transaction. Co-investisseurs : AIP (Stonepeak Infrastructure Partners), BlackRock Global Infrastructure Partners. Vendeur : Macquarie Asset Management (propriétaire depuis 2018). Actifs acquis : **51 campus**, **6,4 GW** de capacité opérationnelle et planifiée aux Amériques. Management inchangé (Andrew Schaap CEO, siège Dallas TX). [The National + Bloomberg + Gulf News + Data Center Dynamics, 21/07/2026]
- Orientations stratégiques : Double mécanisme d'influence structurelle sur l'IA mondiale : (1) fonds d'investissement ($49 Md Fund I → Anthropic/OpenAI/xAI = stake dans les 3 labs frontière US) + (2) acquisition directe d'infrastructure ($40 Md Aligned DC = 6,4 GW capacité physique). Abu Dhabi positionné comme acteur d'infrastructure IA tier-1 mondial en trois semaines (01/07 Fund I + 21/07 Aligned). Absence de tout acteur EU dans ce consortium.
- À surveiller : Déploiement du $5 Md capex additionnel Aligned (géographies cibles) ; nouvelles acquisitions DC hors Amériques (EU, Asie-Pacifique) ; positionnement MGX sur l'infrastructure EU et impact sur les stratégies de souveraineté.
...
- Dernière MAJ : 10/08/2026
- Financement : société cotée (Hong Kong : 1211 ; Shenzhen : 002594) ; CA 2025 : ~777 Md CNY (~107 Md$).
- Produits / modèles : véhicules électriques (n°1 mondial EVP en volume) ; unité robotique interne depuis 2022.
- Produits / modèles robotique :
  **Début août 2026 — Xiao Di** : premier humanoïde BYD, dévoilé dans les showrooms D Space (Zhengzhou). Dimensions : 1,61 m, 58,5 kg. Capacités : accueil clients, démonstrations véhicules, traduction temps réel (6 dialectes chinois + 6 langues étrangères). Déploiement initial : showrooms de Shenzhen et Shanghai ; extension à 50 sites prévue à court terme. Les États-Unis ont appliqué des restrictions à l'exportation immédiatement après l'annonce. [notebookcheck.net ; KR-Asia ; South China Morning Post — début août 2026]
- Orientations stratégiques : Entrée dans la robotique humanoïde de service ; intégration stratégique automobile + IA physique. Compétition directe avec Tesla Optimus sur le segment service/accueil.
- À surveiller : Déploiement commercial Xiao Di (objectif 50 sites) ; réaction réglementaire US/UE aux restrictions export ; partenariats IA physique pour la formation des modèles embarqués ; extension hors Chine.
...
## Manus (Chine, agents IA autonomes)
- Dernière MAJ : 21/09/2026
- Financement : **$500 M tour en cours** (annoncé 17/09/2026) — valorisation cible $4 Md (×2 vs $2 Md précédent). Investisseurs cibles : IDG Capital, Boyu Capital, CATL, + existants Tencent, HSG, ZhenFund. Premier tour depuis le blocage NDRC de l'acquisition par Meta (avril 2026). IPO Hong Kong envisagée (H2 2026/début 2027). [Bloomberg, 17/09/2026 ; TechCrunch, 18/09/2026]
- Produits / modèles : Agent IA autonome concurrent de Claude Computer Use / OpenAI Operator / H Company Holo. Positionnement "agentic AI pioneer" selon Bloomberg.
