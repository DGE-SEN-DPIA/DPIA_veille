...
- À surveiller : Dépôt S-1 public EDGAR (fenêtre critique semaine 22/09) ; réponse RFI Bureau IA EU (deadline 29/09) ; roadshow institutionnel Nasdaq ; cotation Nasdaq cible octobre 2026 ; validation valorisation $2T ; LSVP extension plans individuels ; autres évaluateurs intégrés (METR et non-lucratifs).
...
- Produits / modèles :
  ...
  **07/08/2026 — Grok 4.6 lancé** : Architecture V9 inchangée (1,5T params) — gains par SFT et RL renforcés. Aucun benchmark officiel publié, aucune model card, aucune évaluation de sécurité publiée. Positionnement déclaré : rivaux Kimi K3 (~2,8T) et Claude Opus 5. Grok 4.7 (~2,1T) toujours prévu ~21/08. [kie.ai ; tbreak.com ; roic.ai — 07/08/2026]
...
- Dernière MAJ : 10/08/2026
- À surveiller : API console EU Grok 4.5 (résultat évaluation GPAI AI Act) ; lancement Grok 4.7 (~21/08) ; absence de benchmarks Grok 4.6 = opacité concurrentielle ; Grok 5 (roadmap) ; nouvelles intégrations cloud.
