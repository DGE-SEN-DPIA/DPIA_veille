...
- Produits / modèles : Mistral Large (série) ; Leanstral 1.5 (119B MoE, Lean 4, Apache 2.0, 02/07/2026) ; Robostral Navigate (8B, navigation robotique monoculaire SOTA, 08/07/2026) ; MoE open-weight "fat but sparse" (early access partenaires juillet 2026, release publique été 2026 non datée) ; **OCR 4.1 GA (31/08/2026)** : bounding boxes paragraphes, labels structurés, scores de confiance par bloc, 170 langues, $4/1k pages — alias mistral-ocr-latest et mistral-ocr-4 ; Voxtral TTS ; **Shieldstral** (04/08/2026, 3B, multimodal texte+images, Apache 2.0, 12 langues, 16 Go VRAM — classificateur sécurité politique-adaptive, SOTA modération multimodale, AI Act Art. 13)
...
- **Série D — annonce officielle 08/09/2026 :** Mistral publie l'annonce officielle sur mistral.ai. Valorisation post-money : **>€21 Md** (vs €20 Md sources initiales du 08/09 matin — correction officielle). Lead : Samsung Electronics. Co-leads : EQT Scaleup Europe Fund (BEI), PSG Equity. **Nouveaux entrants** : Advent, fonds BlackRock, Grand-Duché de Luxembourg. Participants existants : a16z, ASML, Belfius, BNP Paribas CIB, Bpifrance, Carmignac, DST Global, Eurazeo, General Catalyst, Headline, Hillspire, Index Ventures, Korelya Capital, Lightspeed, NVIDIA, Phoenix Court/Solar, Salesforce Ventures. 20 pays, 125+ entreprises clients (Airbus, ASML, HSBC cités). Qualifié de "plus grande levée equity jamais réalisée par une entreprise tech européenne" (3 ans après création). (Sources : mistral.ai/news, TechCrunch, Sifted — 08/09/2026)
- Dernière MAJ : 11/09/2026
- À surveiller : ouverture Les Ulis (Q3 2026, fenêtre se ferme 30/09 — 19 jours restants) ; premiers contrats Priority Tier avec administrations ; expansion coalition EU ; premiers résultats industriels surrogate models BMW/Airbus ; déploiement Agentic Search filière financière et administration FR ; résultats PIIEC IA (instruction automne 2026)
...
- **R&D Automation Index — Claude leads 26 % R&D interne (17/09/2026) :** Anthropic publie les premiers résultats de son R&D Automation Index (Anthropic Institute, 17/09). En août 2026, Claude « leads » 26 % des tâches de R&D d'Anthropic, en hausse depuis <1 % en février 2026. « Leads » = complète l'essentiel d'une tâche de bout en bout depuis une instruction haut niveau, sous supervision humaine (AL3-4 sur l'échelle AL0-AL5 Epoch AI). Plus de 90 % des tâches de R&D impliquent l'IA au moins en assistance. Aucun point d'opération pleinement autonome (AL5) documenté à ce jour. Premier grand lab à quantifier et publier le RSI endogène dans son pipeline de développement — directement lié à l'essai Amodei 12/09. (Sources : Bloomberg, WaPo, Engadget, Unite.AI — 4 sources, confiance élevée)
- Dernière MAJ : 18/09/2026
- À surveiller : dépôt S-1 public EDGAR (fenêtre critique semaine du 22/09) ; Nasdaq listing octobre 2026 ; évolution R&D Automation Index (prochaine publication) ; Daybreak Blue accès EU (ANSSI/BSI/OIV) ; évolution démissions sécurité → METR ; Ode premiers déploiements
...
- **Astra déploiement finalisé 06/09/2026 :** Au 06/09, Astra est live pour tous abonnés Plus/Pro/Business/Enterprise + API OpenAI/Azure/AWS Bedrock. Aucun incident public signalé. Daybreak Blue EU accès toujours en suspens.
- **IPO reporté à 2027 — CONFIRMÉ officiellement (12/09/2026) :** Sam Altman déclare dans une interview Fortune que 2026 serait "ill-advised" pour une IPO. "Not 2026." Pointe 2027. Justification safety : "it is unacceptable to be taking like a 10% chance of killing everybody by end of the decade." Mentionne pauses potentielles dans training runs aux nouveaux seuils de capacité. Synchrone avec l'essai Amodei/pacing. L'inscription confidentielle SEC du 01/06/2026 reste en vigueur sans date de mise au marché. (Axios, Fortune, WION — 3 sources, confiance élevée)
...
- **DeepMind Institute (16/09/2026) :** Hassabis, Shane Legg (cofondateur/managing editor) et James Manyika (SVP Research Technology & Society, Google) lancent le DeepMind Institute — think tank AGI hébergé dans Google DeepMind. Publication inaugurale : 4 essais (politique économique pour AGI, transparence raisonnement modèles, accès global, prospérité humaine). Accueille des chercheurs extérieurs ; disclamer séparant les opinions des auteurs de la politique Google. Cohérent avec l'endossement du pacing par Hassabis (12/09 : "direction is correct"). (Sources : Axios 16/09, TechCrunch 17/09, WION 17/09)
- Dernière MAJ : 18/09/2026
- À surveiller : Gemini 3.5 Pro sortie (aucune date officielle — 17e+ délai) ; Gemini 4 annonce ; DeepMind Institute publications régulières ; partenariats industriels Gemini Robotics 2 ; impact reorg sur roadmap
