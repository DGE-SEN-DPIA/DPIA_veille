...
- **GPT-6 Astra lancé 03/09/2026 :** Rollout Daybreak Blue (cybersécurité) immédiat, puis Pro/Plus/Enterprise/API dans la semaine. Prix : $10/MTok input, $50/MTok output. Contexte : 1,1 M tokens. Benchmarks : ARC-AGI-3 99,9 %, ExploitBench 100 %, FrontierMath Tier 4 v2 97,6 %, GPQA Diamond 96 %, DeepSWE v1.1 74,1 %. Technique d'inférence « opaque recurrence » : chaîne de pensée masquée — Pachocki assume publiquement. Greg Brockman : « I do think we're there » (AGI era). Contrat Microsoft renégocié : AGI triggering contractuel supprimé. (Sources : TechCrunch 03/09, CNBC 03/09, 9to5Google 03/09)
- Dernière MAJ : 04/09/2026
- À surveiller : rollout Pro/Plus/Enterprise/API (semaine du 04/09) ; accès EU Daybreak Blue (ANSSI, BSI, OIV) ; conformité opaque recurrence AI Act Art. 13/50 ; Doug lancement (avant nov. 2026) ; rapport technique ExploitGym ; IPO 2027.
...
- **Acquisition Hugging Face — ACCORD SIGNÉ 03/09/2026 :** NVIDIA annonce officiellement l'acquisition de Hugging Face pour **$12,93 Md** ($11,9 Md aux actionnaires + $1 Md equity rétention employés). Jensen Huang : « Together, we will make AI more open, more capable and more accessible. » Engagement : plateforme ouverte maintenue, support multi-modèles, multi-cloud, multi-accélérateurs. Closing attendu H1 2027. HSR (FTC/DoJ US) à déposer ; DG COMP EU revue complète probable. MLex pointe l'antitrust fault line : contrôle du principal hub open source mondial par le premier fournisseur GPU IA. 18 M de développeurs, 3 M de modèles, 500 K datasets, 1 M d'apps concernés. Enjeu FR/EU : neutralité de la plateforme condition de la stratégie souveraineté (EuroHPC AION, Mistral, Kyutai, Pleias). (Sources : NVIDIA Blog 03/09, Bloomberg 03/09, TechCrunch 03/09, MLex 03/09)
- Dernière MAJ : 04/09/2026
- À surveiller : dépôt HSR FTC/DoJ ; notification DG COMP EU ; conditions imposées par régulateurs sur neutralité plateforme ; impact EuroHPC AION (HF membre du consortium AION candidat PIIEC) ; rampe Vera Rubin Q3 ; FY2028 supply constraints
...
- **Accord NVIDIA $12,93 Md SIGNÉ 03/09/2026 :** NVIDIA et Hugging Face annoncent conjointement l'accord. Montant définitif : $12,93 Md ($11,9 Md shareholders + $1 Md equity équipe). Engagement Jensen Huang : plateforme maintenue ouverte, multi-accélérateurs, multi-cloud. Traction : 18 M développeurs, 3 M modèles, 500 K datasets, 200 K+ entreprises. Closing H1 2027 sous condition antitrust. HSR FTC/DoJ à déposer ; DG COMP EU : revue complète probable (taille deal + position dominante NVIDIA GPU). Enjeu FR/EU : Hugging Face est membre du consortium AION candidat PIIEC IA (deadline 09/09) — statut sous contrôle NVIDIA non clarifié. (Sources : NVIDIA Blog 03/09, Bloomberg 03/09, TechCrunch 03/09, MLex 03/09)
- Dernière MAJ : 04/09/2026
- À surveiller : dépôt HSR FTC/DoJ ; notification DG COMP EU ; conditions open access post-acquisition ; position ARIANE/DINUM sur dépendance plateforme ; éligibilité HF au financement public EU post-acquisition ; réaction communauté open source FR (Mistral, Kyutai, Pleias) ; impact sur candidature AION EuroHPC
